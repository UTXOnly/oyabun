...
- Control script: `tools/oyabaunctl.py` (state under `.oyabaun/`). Export levels: `python3 tools/oyabaunctl.py export-world --blend /path/to/scene.blend` → `client/levels/tokyo_alley.glb` (+ optional JSON).
