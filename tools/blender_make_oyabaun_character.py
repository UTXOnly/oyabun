...
**skin-modifier humanoids** built outside this file; the Python that generated them was
never committed. See **docs/CHARACTER_PIPELINE_HANDOFF.md** (share with Claude to recover the script).
...
def _fail_default() -> None:
    msg = """oyabaun: character GLBs are authored meshes (skin modifier pipeline), not generated by this script.

  Read: docs/CHARACTER_PIPELINE_HANDOFF.md
