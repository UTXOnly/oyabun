#!/usr/bin/env python3
"""
Build an Oyabaun game atlas (8 dirs × idle + walk rows) from a PixelLab character ZIP.
...
def main() -> None:
    ...
    p.add_argument(
        "--animation",
        default="walking",
        help="Animation folder name inside ZIP (default: walking)",
    )
    args = p.parse_args()
